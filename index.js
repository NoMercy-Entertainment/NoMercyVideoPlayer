			...
			tracks: [
				{
					label: 'English (Full)',
					type: 'sdh',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).eng.full.vtt',
					language: 'eng',
					kind: 'subtitles',
				},
				{
					label: 'French (Full)',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).fre.full.vtt',
					language: 'fre',
					kind: 'subtitles',
				},
				{
					label: 'Italian (Full)',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).ita.full.vtt',
					language: 'ita',
					kind: 'subtitles',
				},
				{
					label: 'Norwegian (Full)',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).nor.full.vtt',
					language: 'nor',
					kind: 'subtitles',
				},
				{
					label: 'Swedish (Full)',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).swe.full.vtt',
					language: 'swe',
					kind: 'subtitles',
				},
				{
					label: 'Dutch (Full)',
					file: 'https://media.nomercy.tv/Films/Films/Tears.of.Steel.(2012)/subtitles/Tears.of.Steel.(2012).dut.full.vtt',
					language: 'dut',
					kind: 'subtitles',
				},
			],
