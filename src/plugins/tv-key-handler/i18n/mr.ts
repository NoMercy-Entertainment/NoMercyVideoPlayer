...
export default {
	'plugin.tv-key-handler.info.chapter': 'प्रकरण',
	'plugin.tv-key-handler.info.noTitle': 'शीर्षक नाही',
	'plugin.tv-key-handler.info.timeRemaining': 'उर्वरित',
	...
	'plugin.tv-key-handler.aspectRatio.cycled': 'गुणोत्तर',
	'plugin.tv-key-handler.bookmark.added': 'बुकमार्क जोडले',
