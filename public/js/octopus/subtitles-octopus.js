const SubtitlesOctopus = function (options) {
	...
	if (supportsWebAssembly) {
		self.workerUrl = options.workerUrl || 'subtitles-octopus-worker.ts'; // Link to WebAssembly worker
	} else {
		self.workerUrl = options.legacyWorkerUrl || 'subtitles-octopus-worker-legacy.ts'; // Link to legacy worker
	}
