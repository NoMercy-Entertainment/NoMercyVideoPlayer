...
> **[▶ Live Example](https://examples.nomercy.tv/tutorial?step=8)** · **[View full source](https://github.com/NoMercy-Entertainment/nomercy-examples/blob/master/src/components/TutorialPlayer/steps/step8Plugin.ts)** · **[View built-in PlayerUIPlugin](https://github.com/NoMercy-Entertainment/nomercy-video-player/blob/master/src/plugins/playerUIPlugin.ts)**
